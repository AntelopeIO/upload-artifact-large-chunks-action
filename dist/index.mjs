...
exports = module.exports = __nccwpck_require__(4149);
exports.log = log;
...
exports.humanize = __nccwpck_require__(4004);
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(8865);
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(7561);
/* harmony import */ var node_https__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(2286);
...
const httpsagent = new node_https__WEBPACK_IMPORTED_MODULE_2__.Agent({keepAlive: true});

try {
   axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"].defaults.headers.common.Authorization */ .Z.defaults.headers.common.Authorization = `Bearer ${process.env.ACTIONS_RUNTIME_TOKEN}`;
   axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"].defaults.headers.common.Accept */ .Z.defaults.headers.common.Accept = 'application/json;api-version=6.0-preview';
   ...
   const ret = await axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"].post */ .Z.post(artifactURL, createArtifactParams, {httpsAgent: httpsagent});
   ...
   const sz = node_fs__WEBPACK_IMPORTED_MODULE_1__.statSync(path).size;
   ...
   while(offset != sz) {
      ...
      while(true) {
         try {
            const ret = await axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"].put */ .Z.put(`${uploadURL}?itemPath=${name}/${path}`, node_fs__WEBPACK_IMPORTED_MODULE_1__.createReadStream(path, {start, end}), {
   ...
   await axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"].patch */ .Z.patch(`${artifactURL}&artifactName=${name}`, {"Size": sz}, {httpsAgent: httpsagent});
...
/******/ var __webpack_exports__ = __nccwpck_require__(6955);
